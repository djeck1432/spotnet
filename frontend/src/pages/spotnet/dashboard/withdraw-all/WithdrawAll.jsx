  ...
  return (
    <DashboardLayout title="Withdraw All">
      ...
      <div className="flex flex-col max-w-[600px] md:max-w-[640px]">
        ...
        <div className="bg-warning-colour-alt border border-2 border-warning-colour text-second-primary text-center p-3 flex flex-col justify-center items-center rounded-lg w-full mx-auto mt-12 mb-12 gap-5 md:px-6 md:py-4 md:gap-0 sm:mt-9 sm:mb-9 sm:px-6 sm:text-lg sm:flex-wrap sm:gap-4">
